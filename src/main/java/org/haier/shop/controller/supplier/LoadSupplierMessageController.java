...
public class LoadSupplierMessageController {
	@Resource
	private SupplierService supService;
	
	@RequestMapping("/loadSupplierMessage.do")
	@ResponseBody
	public NoteResult execute(String manager_unique,String manager_token,String supplier_unique){
		return supService.loadSupplierMessage(manager_unique, manager_token, supplier_unique);
	}
}
